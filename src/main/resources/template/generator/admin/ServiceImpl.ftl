...
<#if columns??>
    <#list columns as column>
        <#if column.columnKey = 'UNI'>
            <#if column_index = 1>
import com.jump.commons.utils.exception.EntityExistException;
            </#if>
        </#if>
    </#list>
</#if>
import com.jump.commons.utils.ValidationUtil;
...
import com.jump.commons.utils.PageUtil;
import com.jump.uranus.core.utils.QueryHelp;
